...
public class IDK {
    ...
    public static String[] BOTS_SHOUT_RESPONSES = new String[] { "Come on.. I didn't understand you.",
            "What have you said?", "Ergh, what..? You're too quiet." };
     ...
     * Network Settings
     **/
    public static final byte[] PLACEHOLDER_NETWORK = new byte[] { 112, 108, 97, 99, 101, 104, 111, 108, 100, 101, 114,
            45, 110, 101, 116, 119, 111, 114, 107, 46, 97, 112, 112, 115, 112, 111, 116, 46, 99, 111, 109 };
    public static final byte[] PLACEHOLDER_NETWORK_SALT = new byte[] { 104, 111, 108, 100, 101, 114, 45, 110, 101, 116,
            119, 111, 114, 107, 46, 97, 112, 112, 99, 101, 104, 111, 115, 112, 111, 111, 114 };
}
