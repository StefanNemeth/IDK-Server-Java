...
public class AchievementProgressWriter extends MessageWriter {
    ...
    public AchievementProgressWriter(final Achievement achievement, final int targetLevel,
    final AchievementLevel targetLevelData, final int totalLevels, final PlayerAchievement playerData) {
